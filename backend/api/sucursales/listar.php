...
try {
    ...
    if ($pdo) {
        ...
        // Mapear al formato esperado en front
        $items = array_map(function($r) use ($city) {
            $item = [
                'id' => (int)$r['id'],
                'ciudad' => null, // No hay columna dedicada; opcionalmente parsear de direccion
                'colonia' => $r['nombre'], // usar nombre de sede como etiqueta secundaria
                'horario' => '—',
                'servicios' => [],
                'lat' => null,
                'lng' => null,
